      ...
      let getquery = connection.query(getsql, (err, result) => {
        ...
        let nend = missing.length - 1;
            ...
            let refreshID = setInterval(function(){
                    ...
                    let paddedID = leftpad(missing[n], 8, "0");
                    //console.log(paddedID);
                    rp("https://www.psacard.com/cert/"+paddedID+"/")
                      .then((html) => {
                        ...
                        //let csvAsSingleRow = record.join(',')+" \n";
                        console.log(record[0]);
                        //logStream.write(csvAsSingleRow);
